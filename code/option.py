...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/zd/下载',
...
parser.add_argument('--scale', default='4',
                    help='super resolution scale')  # args.scale  超分倍数 所在  默认为4
...
parser.add_argument('--n_resblocks', type=int, default=20,
                    help='number of residual blocks') # 残差层数 20层
parser.add_argument('--n_feats', type=int, default=64,
                    help='number of feature maps')    # 特征选择数量
...
parser.add_argument('--epochs', type=int, default=1000,
                    help='number of epochs to train')  # 迭代次数默认1000次
...
# test_only出现 若调用时加入--test_only 则args.test_only就为ture
